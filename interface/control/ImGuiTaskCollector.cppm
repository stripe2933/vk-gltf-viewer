...
namespace vk_gltf_viewer::control {
    ...
    public:
        ...
        void inputControl(Camera &camera, bool& automaticNearFarPlaneAdjustment, full_optional<AppState::Outline> &hoveringNodeOutline, full_optional<AppState::Outline> &selectedNodeOutline, bool canSelectBloomModePerFragment);
