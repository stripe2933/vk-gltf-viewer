...
namespace vk_gltf_viewer::control {
    ...
    public:
        ...
        void sceneHierarchy(fastgltf::Asset &asset, std::size_t sceneIndex, std::unordered_set<std::size_t> &visibleNodes, const std::optional<std::size_t> &hoveringNodeIndex, const std::unordered_set<std::size_t> &selectedNodeIndices);
