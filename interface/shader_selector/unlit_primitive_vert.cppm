...
import vk_gltf_viewer.shader.unlit_primitive_vert;
...
std::span<const unsigned int> vk_gltf_viewer::shader_selector::unlit_primitive_vert(int HAS_BASE_COLOR_TEXTURE, int HAS_COLOR_0_ATTRIBUTE) {
    return std::visit(
