...
std::span<const unsigned int> vk_gltf_viewer::shader_selector::primitive_frag(int TEXCOORD_COUNT, int HAS_COLOR_0_ATTRIBUTE, int FRAGMENT_SHADER_GENERATED_TBN, int ALPHA_MODE, int EXT_SHADER_STENCIL_EXPORT) {
    return std::visit(
