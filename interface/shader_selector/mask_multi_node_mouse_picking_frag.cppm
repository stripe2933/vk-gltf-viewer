...
std::span<const unsigned int> vk_gltf_viewer::shader_selector::mask_multi_node_mouse_picking_frag(int HAS_BASE_COLOR_TEXTURE, int HAS_COLOR_0_ALPHA_ATTRIBUTE) {
    return std::visit(
