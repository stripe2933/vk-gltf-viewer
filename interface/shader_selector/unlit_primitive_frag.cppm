...
import vk_gltf_viewer.shader.unlit_primitive_frag;
...
std::span<const unsigned int> vk_gltf_viewer::shader_selector::unlit_primitive_frag(int HAS_BASE_COLOR_TEXTURE, int HAS_COLOR_0_ATTRIBUTE, int ALPHA_MODE) {
    return std::visit(
