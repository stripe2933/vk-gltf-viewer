...
namespace vk_gltf_viewer::vulkan::inline pipeline {
    export class UnlitPrimitiveRenderPipelineSpecialization {
    public:
        ...
        [[nodiscard]] bool operator==(const UnlitPrimitiveRenderPipelineSpecialization&) const noexcept = default;
...
struct vk_gltf_viewer::vulkan::pipeline::UnlitPrimitiveRenderPipelineSpecialization::VertexShaderSpecializationData {
...
struct vk_gltf_viewer::vulkan::pipeline::UnlitPrimitiveRenderPipelineSpecialization::FragmentShaderSpecializationData {
    vk::Bool32 useTextureTransform;
};

vk::raii::Pipeline vk_gltf_viewer::vulkan::pipeline::UnlitPrimitiveRenderPipelineSpecialization::createPipeline(
...
std::array<int, 2> vk_gltf_viewer::vulkan::pipeline::UnlitPrimitiveRenderPipelineSpecialization::getVertexShaderVariants() const noexcept {
    return {
...
vk_gltf_viewer::vulkan::pipeline::UnlitPrimitiveRenderPipelineSpecialization::VertexShaderSpecializationData vk_gltf_viewer::vulkan::pipeline::UnlitPrimitiveRenderPipelineSpecialization::getVertexShaderSpecializationData() const noexcept {
...
std::array<int, 3> vk_gltf_viewer::vulkan::pipeline::UnlitPrimitiveRenderPipelineSpecialization::getFragmentShaderVariants() const noexcept {
    return {
        baseColorTexcoordComponentTypeAndNormalized.has_value(),
        color0ComponentTypeAndCount.has_value(),
...
vk_gltf_viewer::vulkan::pipeline::UnlitPrimitiveRenderPipelineSpecialization::FragmentShaderSpecializationData vk_gltf_viewer::vulkan::pipeline::UnlitPrimitiveRenderPipelineSpecialization::getFragmentShaderSpecializationData() const noexcept {
