...
export module vk_gltf_viewer:vulkan.pipeline.PrimitiveBoundingSphereRenderer;
...
export import glm;
import vku;
import :shader.primitive_bounding_sphere_vert;
import :shader.primitive_bounding_volume_frag;
export import :vulkan.pl.PrimitiveBoundingVolume;
export import :vulkan.rp.Scene;

namespace vk_gltf_viewer::vulkan::inline pipeline {
    export struct PrimitiveBoundingSphereRenderer : vk::raii::Pipeline {
        PrimitiveBoundingSphereRenderer(
            ...
            const rp::Scene &sceneRenderPass LIFETIMEBOUND
                ...
                createPipelineStages(
                    device,
                    vku::Shader { shader::primitive_bounding_sphere_vert, vk::ShaderStageFlagBits::eVertex },
