...
export module vk_gltf_viewer.vulkan.pipeline.MaskMousePickingRenderer;

import std;
export import fastgltf;
import vku;

import vk_gltf_viewer.shader_selector.mask_mouse_picking_frag;
...
namespace vk_gltf_viewer::vulkan::inline pipeline {
    export class MaskMousePickingRendererSpecialization {
    public:
        ...
        [[nodiscard]] bool operator==(const MaskMousePickingRendererSpecialization&) const = default;
...
struct vk_gltf_viewer::vulkan::pipeline::MaskMousePickingRendererSpecialization::VertexShaderSpecializationData {
...
struct vk_gltf_viewer::vulkan::pipeline::MaskMousePickingRendererSpecialization::FragmentShaderSpecializationData {
    vk::Bool32 useTextureTransform;
};

vk::raii::Pipeline vk_gltf_viewer::vulkan::pipeline::MaskMousePickingRendererSpecialization::createPipeline(
    ...
    return { device, nullptr, vk::StructureChain {
        vku::getDefaultGraphicsPipelineCreateInfo(
            createPipelineStages(
                ...
                vku::Shader {
                    std::apply(LIFT(shader_selector::mask_mouse_picking_frag), getFragmentShaderVariants()),
...
std::array<int, 2> vk_gltf_viewer::vulkan::pipeline::MaskMousePickingRendererSpecialization::getVertexShaderVariants() const noexcept {
    return {
...
vk_gltf_viewer::vulkan::pipeline::MaskMousePickingRendererSpecialization::VertexShaderSpecializationData vk_gltf_viewer::vulkan::pipeline::MaskMousePickingRendererSpecialization::getVertexShaderSpecializationData() const noexcept {
...
std::array<int, 2> vk_gltf_viewer::vulkan::pipeline::MaskMousePickingRendererSpecialization::getFragmentShaderVariants() const noexcept {
    return {
        baseColorTexcoordComponentTypeAndNormalized.has_value(),
        color0AlphaComponentType.has_value(),
    };
...
vk_gltf_viewer::vulkan::pipeline::MaskMousePickingRendererSpecialization::FragmentShaderSpecializationData vk_gltf_viewer::vulkan::pipeline::MaskMousePickingRendererSpecialization::getFragmentShaderSpecializationData() const noexcept {
