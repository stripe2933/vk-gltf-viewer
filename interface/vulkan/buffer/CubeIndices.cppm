...
[[nodiscard]] auto unmap(vma::Allocator allocator, vku::MappedBuffer &&buffer) -> vku::AllocatedBuffer {
...
namespace vk_gltf_viewer::vulkan::buffer {
    ...
    export struct CubeIndices : vku::AllocatedBuffer {
        ...
        ) : AllocatedBuffer { unmap(allocator, vku::MappedBuffer { allocator, std::from_range, std::array<std::uint16_t, 36> {
