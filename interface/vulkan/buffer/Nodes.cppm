...
namespace vk_gltf_viewer::vulkan::buffer {
    ...
    public:
        Nodes(
            ...
            const gltf::ds::NodeInstanceCountExclusiveScanWithCount *nodeInstanceCountExclusiveScan = nullptr
        ) : asset { asset },
            ...
            for (const auto &[nodeIndex, node] : asset.nodes | ranges::views::enumerate) {
                data[nodeIndex] = shader_type::Node {
                    ...
                    .pInstancedWorldTransforms = [&]() -> vk::DeviceAddress {
                        ...
                        return instancedNodeWorldTransformBuffer->getDeviceAddress() + sizeof(glm::mat4) * (*nodeInstanceCountExclusiveScan)[nodeIndex];
                    }(),
