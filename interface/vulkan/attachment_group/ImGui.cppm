...
namespace vk_gltf_viewer::vulkan::ag {
    export struct ImGui final : vku::AttachmentGroup {
        ImGui(const Gpu &gpu LIFETIMEBOUND, const vk::Extent2D &extent, std::span<const vk::Image> swapchainImages);
    };
}
...
vk_gltf_viewer::vulkan::ag::ImGui::ImGui(const Gpu &gpu, const vk::Extent2D &extent, std::span<const vk::Image> swapchainImages)
