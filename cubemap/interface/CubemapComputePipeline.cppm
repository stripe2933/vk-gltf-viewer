...
void cubemap::CubemapComputePipeline::recordCommands(vk::CommandBuffer computeCommandBuffer) const {
    ...
    computeCommandBuffer.pushDescriptorSetKHR(
        ...
        0, {
            descriptorSetLayout.getWriteDescriptorSet<0>({}, 0, vku::lvalue(vk::DescriptorImageInfo { {}, *eqmapImageView, vk::ImageLayout::eShaderReadOnlyOptimal })),
            descriptorSetLayout.getWriteDescriptorSet<1>({}, 0, vku::lvalue(vk::DescriptorImageInfo { {}, *cubemapImageView, vk::ImageLayout::eGeneral })),
        }, *d);
