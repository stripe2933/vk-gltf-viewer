...
void bloom::BloomComputePipeline::compute(vk::CommandBuffer computeCommandBuffer, vk::DescriptorSet descriptorSet, const vk::Extent2D &imageExtent, std::uint32_t imageMipLevels, std::uint32_t imageArrayLayers) const {
